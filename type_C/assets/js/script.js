...
function gnbScrollEvent() {
  ...
  // console.log(documentHeight, saveHeight);
  if (documentHeight > saveHeight) {
    saveHeight = documentHeight;
    $header.css({ position: "absolute" });
  } else if (documentHeight < saveHeight) {
    saveHeight = documentHeight;
...
function se3ClickEvent() {
  let $swipe1 = $(
    "#section3 .main-swiper3 .swiper-wrapper .swiper-slide .Swiper-1"
  );
  let $swipe2 = $(
    "#section3 .main-swiper3 .swiper-wrapper .swiper-slide .Swiper-2"
  );
  let $list1_1 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(2)"
  );
  let $list1_2 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(3)"
  );
  let $list1_3 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(4)"
  );
  let $list1_4 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(5)"
  );
  let $list2_1 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(7)"
  );
  let $list2_2 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(8)"
  );
  let $list2_3 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(9)"
  );
  let $list2_4 = $(
    "#section3 .swiper-pagination .swiper-pagination-bullet:nth-child(10)"
  );
  ...
  $list1_1.hover(function () {
    $(this).trigger("click");
  });
  $list1_2.hover(function () {
    $(this).trigger("click");
  });
  $list1_3.hover(function () {
    $(this).trigger("click");
  });
  $list1_4.hover(function () {
    $(this).trigger("click");
  });
  $list2_1.hover(function () {
    $(this).trigger("click");
  });
  $list2_2.hover(function () {
    $(this).trigger("click");
  });
  $list2_3.hover(function () {
    $(this).trigger("click");
  });
  $list2_4.hover(function () {
    $(this).trigger("click");
  });
}
$(document).ready(function () {
...
function sec4ScrollEvent() {
  ...
  if (documentHeight >= section4Top - 300) {
    $sec4.addClass("color3");
    $sec4.removeClass("color4");
    $sec5.addClass("color3");
    $sec5.removeClass("color4");
    $sec6.addClass("color3");
    $sec6.removeClass("color4");
    $footer.addClass("color3");
    $footer.removeClass("color4");
    $right1.addClass("right3");
    $right2.addClass("right4");
    $right1.removeClass("left3");
    $right2.removeClass("left4");
  } else {
    $sec4.addClass("color4");
    $sec4.removeClass("color3");
    $sec5.addClass("color4");
    $sec5.removeClass("color3");
    $sec6.addClass("color4");
    $sec6.removeClass("color3");
    $footer.addClass("color4");
    $footer.removeClass("color3");
    $right1.addClass("left3");
    $right2.addClass("left4");
    $right1.removeClass("right3");
    $right2.removeClass("right4");
  }
}
